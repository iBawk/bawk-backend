...
class UserService:
    ...
    def create_user(self, credentials):
        ...
        try:
            user = UserModel(id=userId, email=credentials.email, password=hashed_password)
    ...
    def authenticate_user(self, credentials):
        ...
        access_token = self.token_service.create_access_token(data=payloadAccess)
        refresh_token = self.token_service.create_refresh_token(data=payloadRefresh)
