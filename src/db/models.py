...
class TransactionsModel(Base):
    ...
    userBuyer_phoneNumber = Column("userBuyer_phoneNumber", String, default="")

    userBuyer_name = Column("userBuyer_name", String, nullable=False)

    userBuyer_mail = Column("userBuyer_mail", String, nullable=False, unique=True)
